...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-4 col-md-5 col-sm-6 mx-auto">
			...
			<form action="/submit" method="POST" id="numbers-form">
				...
				<div class="form-wrapper">
					...
					<?php for ($i=1; $i <= 9; $i++): ?>
						...
						<input type="checkbox" name="<?=$i?>" value="<?=$i?>" id="bonus-number-<?=$i?>">
					
					<?php endfor; ?>

						<br>

						<button class="btn btn-primary"	type="submit">Igraj</button>
